...
open_hw_target
set_property PROGRAM.FILE {../bin/Counter.bit} [get_hw_devices xc7a100t_0]
...
set_property PROGRAM.FILES [list "../bin/Counter.bin" ] [ get_property PROGRAM.HW_CFGMEM [lindex [get_hw_devices xc7a100t_0] 0]]
